	...
	<div id="main">
		<div class="section section-bg-10 pt-11 pb-17">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h2 class="page-title text-center">结算</h2>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="section section-checkout pt-2 pb-7">
        	<form method="post" action="/my_mall/home/order/add">
			<div class="container">
				<div class="row">
                	<h3 class="check-h3">收货地址</h3>
                    <input type="hidden" value="" name="address" id="address"/>
                    <?php if(is_array($address)): foreach($address as $key=>$va): ?><div class="col-md-4">
                        <dl class="item">
                            <dt>
                                <strong class="itemConsignee"><?php echo ($va["name"]); ?></strong>
                            </dt>
                            <dd>
                                <p class="tel itemTel"><?php echo ($va["phonenumber"]); ?></p>
                                <p class="itemRegion"><?php echo ($va["address_province"]); ?> <?php echo ($va["address_city"]); ?> <?php echo ($va["address_county"]); ?></p>
                                <p class="itemStreet"><?php echo ($va["address_info"]); ?> ( <?php echo ($va["postcode"]); ?> ) </p>
                                <span class="edit-btn J_editAddr">编辑</span>
                                <?php if($va["ismoren"] == '是'): ?><span class="moren">默认</span><?php endif; ?>
                            	<input type="hidden" class="_Id" value="<?php echo ($va["Id"]); ?>"/>
                            </dd>
					...
					<!--<div class="col-md-4">
                        <dl class="item">
                            <dt>
                                <strong class="itemConsignee">潘骏杰</strong> <span class="itemTag tag">家</span>
                            </dt>
                            <dd>
                ...
                <div class="row">
                	<h3 class="check-h3">支付方式</h3>
                    <input type="hidden" name="payment" id="payment" value="在线支付"/>
					<div class="col-md-12 check-p payment">
                        <p class="onitem">在线支付</p>
                        <p>支付宝</p>
                        <p>好友代付</p>
					</div>
				</div>
                <div class="row">
                	<h3 class="check-h3">配送方式</h3>
					<div class="col-md-12 check-p">
                       <input type="hidden" name="shippingment" value="快速配送"/>
                       <p class="onitem">快递配送（免运费）</p>
					</div>
				</div>
                <div class="row">
                	<h3 class="check-h3">送货时间</h3>
                    <input type="hidden" name="shippingtime" id="shippingtime" value="不限"/>
					<div class="col-md-12 check-p shippingtime">
                        <p class="onitem">不限送货时间<span>周一至周日</span></p>
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="mt-3 check-h3">订单信息</h3>
                        <div class="box-bd">
                            <dl class="checkout-goods-list">
                                ...
                                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><dd class="item clearfix">
                                    <div class="item-row">
                                        <div class="col col-1">
                                            <div class="g-pic"> <img src="/my_mall/Public/uploads/product_img/<?php echo ($vo["product_img"]); ?>" width="80" height="80"> </div>
                                            <div class="g-info"> <a href="/my_mall/home/product/productinfo/Id/<?php echo ($vo["pro_Id"]); ?>"><?php echo ($vo["pname"]); ?> </a> </div>
                                        </div>
                                        <input type="hidden" name="sId[]" value="<?php echo ($vo["sId"]); ?>" class="s_Id" />
                                        <div class="col col-2">￥<?php echo ($vo["phere_price"]); ?></div>
                                        <div class="col col-3"><?php echo ($vo["pro_num"]); ?></div>
                                        <div class="col col-4"><?php echo ($vo["xiaoji"]); ?></div>
                                    </div>
                                </dd><?php endforeach; endif; ?>
                                <!--<dd class="item clearfix">
                                    <div class="item-row">
                                        <div class="col col-1">
                                            <div class="g-pic"> <img src="/my_mall/Public/home/images/shop/shop_2.jpg" width="80" height="80"> </div>
                                            <div class="g-info"> <a href="#">葡萄 </a> </div>
                                        </div>
                            ...
                            <div class="checkout-count clearfix">
                                <div class="checkout-count-extend xm-add-buy">
                                    ...
                                    <input type="text" name="ment">
                                </div>
                                <div class="checkout-price">
                                    <ul>
                                        <li> 订单总额：<span>￥<?php echo ($allprice); ?></span> </li>
                                        <li> 活动优惠：<span>-￥0.00</span> </li>
                                        <li> 优惠券抵扣：<span id="couponDesc">-￥0.00</span></li>
                                        <li> 运费：<span id="postageDesc">￥0.00</span></li>
                                    </ul>
                                    <p class="checkout-total">应付总额：<span><strong id="totalPrice">￥<?php echo ($allprice); ?></strong></span></p>
                                </div>
                            </div>
                            <div class="checkout-confirm">
                                <a href="/my_mall/home/shopcar/shopcar" class="btn btn-lineDakeLight btn-back-cart">返回购物车</a>
