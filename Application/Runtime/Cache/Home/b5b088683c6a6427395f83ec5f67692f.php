	...
	<header class="header header-mobile">
   	...
   	<div id="main">
		<div class="section section-bg-9 pt-11 pb-17">
			<div class="container">
				<div class="row">
					<div class="col-sm-12"> <h2 class="page-title text-center">关于我们</h2> </div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						...
						<h2 class="text-center section-title mtn-2">关于我们的小故事 </h2>
				...
				<div class="row">
					<div class="about-main-img col-lg-6"> <img src="/my_mall/Public/home/images/about_1.jpg" alt="" /> </div>
					<div class="about-content col-lg-6">
						...
						<div class="about-content-text">
							<p>我们的农场是现代有机农场，是我们的父母，马克和奥利;我们的梦想：提供最好和最健康的有机食品 , 促进社区健康，带来发现和冒险的感觉。</p>
							<p>访问我们的网站，为我们提供新鲜的有机水果和蔬菜的完整清单。<br></p>
						</div>
						<div class="about-carousel" data-auto-play="true" data-desktop="4" data-laptop="4" data-tablet="4" data-mobile="2">
							<a href="/my_mall/Public/home/images/carousel/img_large_1.jpg" data-rel="prettyPhoto[gallery]">
								<img src="/my_mall/Public/home/images/carousel/img_1.jpg" alt="" /> <span class="ion-plus-round"></span> 
							</a>
							<a href="/my_mall/Public/home/images/carousel/img_large_2.jpg" data-rel="prettyPhoto[gallery]">
								<img src="/my_mall/Public/home/images/carousel/img_2.jpg" alt="" /> <span class="ion-plus-round"></span> 
							</a>
							<a href="/my_mall/Public/home/images/carousel/img_large_3.jpg" data-rel="prettyPhoto[gallery]">
								<img src="/my_mall/Public/home/images/carousel/img_3.jpg" alt="" /> <span class="ion-plus-round"></span> 
							</a>
							<a href="/my_mall/Public/home/images/carousel/img_large_4.jpg" data-rel="prettyPhoto[gallery]">
								<img src="/my_mall/Public/home/images/carousel/img_4.jpg" alt="" /> <span class="ion-plus-round"></span> 
							</a>
							<a href="/my_mall/Public/home/images/carousel/img_large_5.jpg" data-rel="prettyPhoto[gallery]">
								<img src="/my_mall/Public/home/images/carousel/img_5.jpg" alt="" /> <span class="ion-plus-round"></span> 
							</a>
							<a href="/my_mall/Public/home/images/carousel/img_large_6.jpg" data-rel="prettyPhoto[gallery]">
								<img src="/my_mall/Public/home/images/carousel/img_6.jpg" alt="" /> <span class="ion-plus-round"></span> 
							</a>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-4 col-sm-12">
						...
						<div class="icon-boxes">
							...
							<div class="icon-boxes-inner">
								<h6 class="icon-boxes-title"> 我们的声誉</h6>
								<p>自2016以来，我们一直在为客户生产有机产品。 </p>
							</div>
						</div>
						<div class="icon-boxes">
							<div class="icon-boxes-icon"><i class="organik-cucumber"></i></div>
							<div class="icon-boxes-inner">
								<h6 class="icon-boxes-title"> 新鲜及无农药</h6>
								<p>我们提供有机无农药和可持续生产的农产品。</p>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-12">
						<div class="text-center"> <img src="/my_mall/Public/home/images/about_pic.png" alt="" /> </div>
					</div>
					<div class="col-md-4 col-sm-12">
						<div class="icon-boxes right">
							<div class="icon-boxes-icon"><i class="organik-broccoli"></i></div>
							<div class="icon-boxes-inner">
								<h6 class="icon-boxes-title">没有承诺的要求</h6>
								<p>我们不需要承诺，允许您取消或暂停交付。</p>
							</div>
						</div>
						<div class="icon-boxes right">
						...
						<div class="icon-boxes right">
							...
							<div class="icon-boxes-inner">
								<h6 class="icon-boxes-title">定制 </h6>
								<p>自定义您的标准交付，以排除您不想要的项目。 </p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						...
						<h2 class="text-center section-title mtn-2">我们是优秀的农民</h2>
				...
				<div class="row">
					<div class="col-md-4 col-sm-12">
						<div class="team-member">
							<div class="image"> <img src="/my_mall/Public/home/images/testimonial/picture_3.jpg" alt="Michael Andrews" /> </div>
							<div class="team-info">
								<h5 class="name">鲁斯</h5>
								<p class="bio">出生于Capay的农场，米迦勒显示在机加工车间的早期水平，是当今设计工具用在农场负责。</p>
								<ul class="social-list">
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="微信"><i class="fa fa-weixin"></i></a></li>
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="微博"><i class="fa fa-weibo"></i></a></li>
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="相片"><i class="fa fa-pinterest"></i></a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-12">
						<div class="team-member">
							<div class="image"> <img src="/my_mall/Public/home/images/testimonial/picture_4.jpg" alt="Kathleen Barsotti" /> </div>
							<div class="team-info">
								<h5 class="name">凯琳</h5>
								<p class="bio">出生在Belmont，CA，凯思琳出席了UC Riverside的她在那里得到专业农业。她是农场的老板和经理。</p>
								<ul class="social-list">
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="微信"><i class="fa fa-weixin"></i></a></li>
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="微博"><i class="fa fa-weibo"></i></a></li>
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="相片"><i class="fa fa-pinterest"></i></a></li>
					...
					<div class="col-md-4 col-sm-12">
						<div class="team-member">
							<div class="image"> <img src="/my_mall/Public/home/images/testimonial/picture_2.jpg" alt="Mark Ronson" /> </div>
							<div class="team-info">
								<h5 class="name">马克</h5>
								<p class="bio">他致力于建立一个强有力的金融模式，让农民通过直接管理我们当前的计划直接将产品与消费者联系起来。</p>
								<ul class="social-list">
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="微信"><i class="fa fa-weixin"></i></a></li>
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="微博"><i class="fa fa-weibo"></i></a></li>
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="相片"><i class="fa fa-pinterest"></i></a></li>
