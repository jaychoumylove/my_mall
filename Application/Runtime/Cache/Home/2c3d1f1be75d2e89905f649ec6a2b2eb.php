...
<link rel="stylesheet" href="/my_mall/Public/home/css/settings.css" type="text/css" media="all">
				...
				<div class="row">
					<div class="col-sm-12 p-0">
						<div id="rev_slider" class="rev_slider fullscreenbanner">
							<ul>
								<li data-transition="flip" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide">
									<img src="/my_mall/Public/home/images/slider/slide_bg_4.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" />
									<div class="tp-caption rs-parallaxlevel-2"
										 ...
										 data-frames='[{"delay":20,"speed":30,"frame":"0","from":"opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
										 data-textAlign="['inherit','inherit','inherit','inherit']"
										 data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
										 data-paddingbottom="[0,0,0,0]"
										 data-paddingleft="[0,0,0,0]">
											<img src="/my_mall/Public/home/images/slider/slide_6.png" alt="" />
									</div>
									<div class="tp-caption rs-parallaxlevel-1"
										 ...
										 data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]">
											<img src="/my_mall/Public/home/images/slider/slide_7.png" alt="" />
									</div>
									<a class="tp-caption btn-2 hidden-xs" href="/my_mall/home/product/product"
								...
								<li data-transition="flip" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide"> 
									<img src="/my_mall/Public/home/images/slider/slide_bg_5.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" />
									<div class="tp-caption rs-parallaxlevel-1"
										 data-x="center" data-hoffset=""
										 ...
										 data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
										 data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]">
											<img src="/my_mall/Public/home/images/slider/slide_8.png" alt="" />
									</div>
								</li>
							</ul>
						</div>
		...
		<div class="section section-bg-1 section-cover pt-17 pb-3">
			<div class="container">
				<div class="row">
					<div class="col-sm-6">
						<div class="mt-3 mb-3">
							<img src="/my_mall/Public/home/images/oranges.png" alt="" />
						</div>
					</div>
					<div class="col-sm-6">
						<div class="mb-1 section-pretitle default-left">Welcome to</div>
						<h2 class="section-title mtn-2 mb-3">果蔬城</h2>
						<p class="mb-4">
							果蔬城，始于2017年，布局了多个水果蔬菜种植基地，从种植到销售，我们都有严格检测，您们吃得放心使我们发展的动力。
						</p>
						<a class="organik-btn arrow" href="#">产品</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						...
						<h2 class="text-center section-title mtn-2">果蔬城</h2>
			...
			<div class="container">
					...
					<div class="col-sm-12 p-0">
						<div class="text-center">
							<ul class="masonry-filter">
								...
								<li><a href="#" data-filter=".dried">干果</a></li>
				...
				<div class="row">
					<div class="product-grid masonry-grid-post">
                    	<?php if(is_array($hotproduct)): foreach($hotproduct as $key=>$vo): ?><div class="col-md-3 col-sm-6 product-item masonry-item text-center vegetables">
							<div class="product-thumb">
								<a href="/my_mall/home/product/productinfo/Id/<?php echo ($vo["PId"]); ?>">
									<div class="badges">
                                    <?php if($vo["Pishot"] == '是'): ?><span class="hot">热</span><?php endif; ?>
                                    <?php if($vo["Pstock"] == '0'): ?><span class="outofstock">空</span><?php endif; ?>
                                    <?php if($vo["Psale"] == '0'): ?><span class="onsale">安全</span><?php endif; ?>
									</div>
									<img src="/my_mall/Public/uploads/product_img/<?php echo ($vo["Pproduct_img"]); ?>" alt="<?php echo ($vo["name"]); ?>" />
								</a>
								<div class="product-action">
                                	<?php if($vo["Pstock"] != '0'): ?><span class="add-to-cart">
										<a href="/my_mall/home/shopcar/add/pro_Id/<?php echo ($vo["PId"]); ?>/pro_num/1" data-toggle="tooltip" data-placement="top" title="加入购物车"></a>
									</span><?php endif; ?>
									<span class="wishlist">
										<a href="/my_mall/home/farite/add/pro_Id/<?php echo ($vo["PId"]); ?>" data-toggle="tooltip" data-placement="top" title="收藏"></a>
									</span>
									<span class="quickview">
										<a href="/my_mall/home/product/productinfo/Id/<?php echo ($vo["PId"]); ?>" data-toggle="tooltip" data-placement="top" title="详情"></a>
									</span>
								</div>
							</div>
							<div class="product-info">
								<a href="/my_mall/home/product/productinfo/Id/<?php echo ($vo["PId"]); ?>">
									<h2 class="title"><?php echo ($vo["Pname"]); ?></h2>
									<span class="price">
                                    <?php if($vo["PMprice"] != ''): ?><del>￥<?php echo ($vo["PMprice"]); ?></del><?php endif; ?>
										<ins>￥<?php echo ($vo["PHprice"]); ?></ins>
									</span>
								</a>
							</div>
					...
					<div class="loadmore-contain">
						<a class="organik-btn small" href="/my_mall/home/product/product"> 更多 </a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						...
						<h2 class="text-center section-title mtn-2">我们的博客</h2>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="blog-grid-item">
							<div class="post-thumbnail">
								<a href="#"> <img src="/my_mall/Public/home/images/blog/blog_1.jpg" alt="" /> </a>
							</div>
							<div class="post-content">
								<div class="entry-meta">
									<span class="posted-on"> <i class="ion-calendar"></i> <span>2017-11-12</span> </span>
									<span class="comment"> <i class="ion-chatbubble-working"></i> 0</span>
								</div>
								<a href="#"> <h1 class="entry-title">如何制作，你的甜心南瓜泥</h1> </a>
								<div class="entry-content"> 把两半切成小块，放在一个大的水里，用一个蒸汽筐把南瓜片保持接触…</div>
								<div class="entry-more"><a href="#">更多</a></div>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="blog-grid-item">
							<div class="post-thumbnail">
								<a href="#"> <img src="/my_mall/Public/home/images/blog/blog_2.jpg" alt="" /> </a>
							</div>
							<div class="post-content">
								<div class="entry-meta">
									<span class="posted-on"> <i class="ion-calendar"></i> <span>2017-12-10</span></span>
									<span class="comment"> <i class="ion-chatbubble-working"></i> 0</span>
								</div>
								<a href="#"> <h1 class="entry-title">大批量食谱，以帮助使用所有的有机蔬菜</h1> </a>
								<div class="entry-content"> 一个装满了有机蔬菜的冰箱，以最好的意图购买或收获，然后生活忙碌起来，没有时间去削皮， </div>
								<div class="entry-more"> <a href="#">更多</a> </div>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="blog-grid-item">
							...
							<div class="post-content">
								<div class="entry-meta">
									<span class="posted-on"> <i class="ion-calendar"></i> <span>2017-12-12</span> </span>
									<span class="comment"> <i class="ion-chatbubble-working"></i> 0</span>
								</div>
								<a href="#"> <h1 class="entry-title">养鱼场如何将鲑鱼有机饲养?</h1> </a>
								<div class="entry-content"> 有机食品消费快速增长。对全球环境的高度兴趣和愿意去看 </div>
								<div class="entry-more"> <a href="#">更多</a> </div>
							</div>
						</div>
					</div>
					...
					<div class="col-sm-12">
						<div class="client-carousel" data-auto-play="true" data-desktop="5" data-laptop="3" data-tablet="3" data-mobile="2">
							<!--<div class="client-item">
								<a href="#" target="_blank"> <img src="/my_mall/Public/home/images/client/client_1.png" alt="" /> </a>
							</div>-->
                            <div class="client-item">
								<a href="#" target="_blank"> <img src="/my_mall/Public/home/images/client/client_1.png" alt="" /> </a>
							</div>
							<div class="client-item">
								<a href="#" target="_blank"> <img src="/my_mall/Public/home/images/client/client_2.png" alt="" /> </a>
							</div>
							<div class="client-item">
								<a href="#" target="_blank"> <img src="/my_mall/Public/home/images/client/client_3.png" alt="" /> </a>
							</div>
							<div class="client-item">
								<a href="#" target="_blank"> <img src="/my_mall/Public/home/images/client/client_4.png" alt="" /> </a>
							</div>
							<div class="client-item">
								<a href="#" target="_blank"> <img src="/my_mall/Public/home/images/client/client_5.png" alt="" /> </a>
							</div>
                            <div class="client-item">
								<a href="#" target="_blank"> <img src="/my_mall/Public/home/images/client/client_1.png" alt="" /> </a>
							</div>
...
<script type="text/javascript" src="/my_mall/Public/home/js/imagesloaded.pkgd.min.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/isotope.pkgd.min.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/jquery.isotope.init.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/script.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/extensions/revolution.extension.video.min.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/extensions/revolution.extension.slideanims.min.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/extensions/revolution.extension.actions.min.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/extensions/revolution.extension.kenburn.min.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/extensions/revolution.extension.navigation.min.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/extensions/revolution.extension.migration.min.js"></script>
<script type="text/javascript" src="/my_mall/Public/home/js/extensions/revolution.extension.parallax.min.js"></script>
