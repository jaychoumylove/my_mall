...
<body>
    ...
    <ul class="forminfo">
 	<form action="/my_mall/Admin/Admin/add" method="post">
    <li><label>用户名<b>*</b></label><input name="adminname" type="text" class="dfinput" /></li> 
    <li><label>密码<b>*</b></label>
    <input name="adminpwd" type="password" class="dfinput" />
    </li>
    <li><label>重复密码<b>*</b></label>
    <input name="radminpwd" type="password" class="dfinput" />
    </li>      
    ...
    <li><label>真实姓名<b>*</b></label><input name="realname" type="text" class="dfinput"  /></li>
    ...
    <form action="/my_mall/Admin/Admin/admin" method="post">
    <ul class="seachform">
    <li><label>性别</label>  
    <div class="vocation">
	...
	<li><label>真实姓名</label><input name="name" type="text" class="scinput" /></li>
    <li><label>&nbsp;</label><input name="" type="submit" class="scbtn" value="查询"/></li>
  
    </ul>
    </form>
  <form action="/my_mall/Admin/Admin/delAll" method="post">  
    <table class="tablelist">
    	<thead>
    	<tr>
        <th width="6%"><input name="checkAll" id="checkAll" type="checkbox" value=""/></th>
        <th width="12%">用户名<i class="sort"><img src="/my_mall/Public/admin/images/px.gif" /></i></th>
        <th width="17%">真实姓名</th>
        <th width="5%">性别</th>
        <th width="20%">电子邮箱</th>
        <th width="15%">手机号码</th>
        ...
        <td><input name="checkbox_Id[]" type="checkbox" value="<?php echo ($vo["Id"]); ?>"  class="checkbox_Id"/>  </td>
        ...
        <td><a href="/my_mall/Admin/Admin/update/Id/<?php echo ($vo['Id']); ?>" class="tablelink"> 查看/修改</a>    <a href="/my_mall/Admin/Admin/del/Id/<?php echo ($vo['Id']); ?>" class="tablelink"> 删除</a></td>
